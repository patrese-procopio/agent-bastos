    ...
    <div style={{ display:"flex",flexDirection:"column",flex:1,height:"100%",overflow:"hidden",background:C.bg }}>
      ...
      <div style={{ height:48, flexShrink:0, background:"#0F172A", borderBottom:"1px solid rgba(255,255,255,0.07)", display:"flex", alignItems:"center", justifyContent:"space-between", padding:"0 14px" }}>
        <div style={{ display:"flex", alignItems:"center", gap:8 }}>
          ...
          <div>
            <div style={{ fontSize:13, fontWeight:700, color:"#F1F5F9", letterSpacing:"0.03em" }}>Agenda</div>
            <div style={{ fontSize:11, color:"#94A3B8", fontFamily:MONO, letterSpacing:"0.06em" }}>BASTOS-UNIT · AIPEN · Missões e Ordens do Dia</div>
          </div>
        </div>
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          {pendentesCount>0 && <span style={{ fontSize:11, color:"#F87171", fontFamily:MONO, fontWeight:800, background:"rgba(239,68,68,0.15)", border:"1px solid rgba(239,68,68,0.35)", padding:"3px 10px", borderRadius:4, letterSpacing:"0.06em" }}>{pendentesCount} PENDENTE{pendentesCount>1?"S":""}</span>}
