# -*- coding: utf-8 -*-
"""
aplicar_readme.py - escreve o README.md em UTF-8 limpo (sem BOM, sem mojibake).
Python le este arquivo como UTF-8 nativamente, evitando o bug de encoding
do Windows PowerShell com arquivos .ps1.

Uso: python aplicar_readme.py
Rodar na raiz do projeto (Agent_Bastos/).
"""
...
print("[OK] README.md escrito em UTF-8 limpo.")

# Verificacao
with open("README.md", "r", encoding="utf-8") as f:
    conteudo = f.read()

for termo in ["Inteligência", "Transcrição", "análise", "painel.jpg", "Dashboard Operacional"]:
    status = "OK" if termo in conteudo else "FALHOU"
