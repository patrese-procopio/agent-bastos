...
const NAV_GROUPS = [
  ...
  { title: "INTELIGÃŠNCIA", items: [
    { label: "Chat RAG", color: "#1D4ED8" },
    { label: "ReferÃªncias", color: "#6D28D9" },
    { label: "Agenda de MissÃ£o", color: "#B45309", badge: "2" },
  ]},
  { title: "FERRAMENTAS", items: [
    { label: "Dashboard", color: "#065F46" },
    { label: "TranscriÃ§Ã£o", color: "#3730A3" },
    { label: "NotÃ­cias", color: "#C2410C" },
  ]},
]

const AGENDA = [
  { time: "09:00", desc: "Briefing com setor operacional", status: "HOJE" },
  { time: "14:30", desc: "RevisÃ£o â€” Setor Norte", status: "HOJE" },
  { time: "10:00", desc: "ReuniÃ£o com comando regional", status: "AMANHÃƒ" },
]

const NEWS = [
  { title: "Acordo bilateral entre Brasil e Argentina avanÃ§a em questÃµes de defesa", source: "Defesa Net", time: "2h", category: "Defesa", bg: "#DBEAFE", color: "#1D4ED8", img: "https://picsum.photos/seed/defesa/400/200" },
  { title: "Nova tecnologia de vigilÃ¢ncia apresentada no FÃ³rum de SeguranÃ§a Regional", source: "Valor EconÃ´mico", time: "4h", category: "Tecnologia", bg: "#EDE9FE", color: "#6D28D9", img: "https://picsum.photos/seed/tech2/400/200" },
  { title: "OperaÃ§Ã£o conjunta desmantela rede de trÃ¡fico no Amazonas", source: "G1 AM", time: "6h", category: "OperaÃ§Ã£o", bg: "#FFEDD5", color: "#C2410C", img: "https://picsum.photos/seed/op2/400/200" },
  { title: "ReforÃ§o nas fronteiras: medidas estratÃ©gicas anunciadas pelo governo federal", source: "AgÃªncia Brasil", time: "8h", category: "SeguranÃ§a", bg: "#D1FAE5", color: "#065F46", img: "https://picsum.photos/seed/seg2/400/200" },
]

const REFS = [
  { label: "RelatÃ³rios operacionais", color: "#6D28D9" },
  { label: "Documentos histÃ³ricos", color: "#6D28D9" },
  { label: "Arquivos de inteligÃªncia", color: "#1D4ED8" },
  { label: "Busca por perÃ­odo", color: "#1D4ED8" },
...
export default function App() {
  ...
  async function enviarPergunta() {
    ...
    try {
      ...
      setChatHistory(prev => [...prev, { role: "bastos", text: "FALHA: sem conexÃ£o com o backend." }])
    } finally {
      setLoading(false)
    }
  }
  ...
  const isFullScreen = ["Chat RAG","Dashboard","TranscriÃ§Ã£o","Alertas","ReferÃªncias","ConfiguraÃ§Ãµes","Agenda de MissÃ£o"].includes(active)
  return (
    <div style={S.app}>
      <div style={S.dotGrid}/>

      {/* â”€â”€ SIDEBAR â€” sempre visÃ­vel â”€â”€ */}
      <aside style={S.sidebar}>
        ...
        <div style={S.logoArea}>
          ...
          <div>
            ...
            <div style={S.logoTagline}>InteligÃªncia Soberana</div>
          </div>
        </div>
        ...
        <div style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column"}}>
          ...
          <div style={S.statusWidget}>
            <div style={{display:"flex",alignItems:"center",gap:5,marginBottom:8}}>
              ...
              <span style={{fontSize:9,fontWeight:800,color:"#334155",letterSpacing:"0.1em",textTransform:"uppercase"}}>Status de OperaÃ§Ã£o</span>
            </div>
        ...
        <div style={S.sidebarFooter}>
          ...
          <button style={S.configBtn} onClick={()=>setActive("ConfiguraÃ§Ãµes")}>
            <GearIcon/>
            <span style={{fontSize:11,color:"rgba(15,23,42,0.8)",fontWeight:500}}>ConfiguraÃ§Ãµes</span>
          </button>
          <button style={S.policyBtn} onClick={()=>setShowPolicies(true)}>PolÃ­ticas de uso</button>
          <div style={S.copyright}>Â© 2026 Agent Bastos Â· Todos os direitos reservados</div>
        </div>
      </aside>

      {/* â”€â”€ MAIN â€” conteÃºdo dinÃ¢mico â”€â”€ */}
      <main style={S.main}>

        {/* â”€â”€ Telas que tomam o espaÃ§o inteiro do main â”€â”€ */}
        {active === "Chat RAG"    && <ChatRAG     onNavigate={setActive} />}
        {active === "Dashboard"   && <Dashboard   onNavigate={setActive} />}
        {active === "TranscriÃ§Ã£o" && <Transcricao  onNavigate={setActive} />}
        {active === "Alertas"       && <Alertas       onNavigate={setActive} />}
        {active === "NotÃ­cias"      && <Noticias      onNavigate={setActive} />}
        {active === "ReferÃªncias"   && <Referencias   onNavigate={setActive} />}
        {active === "ConfiguraÃ§Ãµes" && <Configuracoes onNavigate={setActive} />}
        {active === "Agenda de MissÃ£o" && <Agenda        onNavigate={setActive} />}
            ...
            <header style={S.topbar}>
              <div style={{display:"flex",alignItems:"center"}}>
                ...
                <div>
                  ...
                  <div style={S.tsub}>24 abr 2026 Â· Manaus, AM</div>
                </div>
              </div>
              <div style={S.chip}>
            ...
            <div style={S.body}>
              ...
              <div style={S.alert}>
                <div style={{display:"flex",alignItems:"center",gap:10,flex:1,minWidth:0}}>
                  <span style={S.alertBadge}>âš  ALERTA</span>
                  <p style={S.alertText}>MovimentaÃ§Ã£o detectada na regiÃ£o de fronteira norte â€” verificar imediatamente</p>
                </div>
                <span style={S.alertTime}>hÃ¡ 12 min</span>
              </div>

              <section>
                <h2 style={S.secLabel}>NotÃ­cias em Destaque</h2>
                    ...
                    <div key={i} style={S.newsCard}>
                      ...
                      <div style={S.newsContent}>
                        ...
                        <div style={{display:"flex",gap:4,marginTop:4,alignItems:"center"}}>
                          ...
                          <span style={{fontSize:9,color:"#CBD5E1"}}>Â·</span>
              ...
              <div style={S.refsBar}>
                <div style={S.refsBarLeft}>
                  ...
                  <span style={{fontSize:9,fontWeight:800,color:"#334155",letterSpacing:"0.1em",textTransform:"uppercase",whiteSpace:"nowrap"}}>Consulta de ReferÃªncias</span>
                </div>
                ...
                <span style={{fontSize:11,color:"#94A3B8",flexShrink:0,fontWeight:600}}>â€º</span>
              </div>
              ...
              <div style={S.chatArea}>
                {chatHistory.length === 0 && (
                  <div style={S.emptyState}>
                    ...
                    <p style={S.emptySubtext}>Inicie uma anÃ¡lise de inteligÃªncia</p>
                  </div>
                )}
                {chatHistory.length > 0 && (
                  <>
                    ...
                    <div style={S.chatMessages}>
                          ...
                          <div style={{
                            ...
                            {m.role==="bastos" && (
                              <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:5}}>
                                <span style={{fontSize:9,color:"#B45309",fontWeight:700,letterSpacing:"0.12em",fontFamily:MONO}}>â—ˆ BASTOS-UNIT</span>
                                <span style={{fontSize:9,color:"#94A3B8",fontFamily:MONO}}>Â· {now}</span>
                              </div>
                            )}
                            {m.text}
                          </div>
                      ...
                      {loading && (
                        <div style={{alignSelf:"flex-start",fontSize:11,color:"#94A3B8",fontFamily:MONO,display:"flex",alignItems:"center",gap:8,zIndex:3,position:"relative"}}>
                          ...
                          processando consulta doutrinÃ¡ria...
                        </div>
                      )}
                      <div ref={chatEndRef}/>
                    </div>
            ...
            <div style={{...S.chatBar,...(focused?S.chatBarFocused:{})}}>
              <div style={S.chatRow}>
                ...
                <input
                  ...
                  placeholder="Pergunte ao Agent Bastos â€” doutrina, anÃ¡lise, referÃªnciasâ€¦"
                />
              ...
              <p style={S.chatHint}>Pressione Enter para enviar Â· Use /comandos para aÃ§Ãµes rÃ¡pidas</p>
            </div>
          </>
        )}

        {/* Telas ainda nÃ£o implementadas */}
        {!["Painel","Chat RAG","Dashboard","TranscriÃ§Ã£o","Alertas","NotÃ­cias","ReferÃªncias","ConfiguraÃ§Ãµes","Agenda de MissÃ£o"].includes(active) && (
      ...
      {/* â”€â”€ MODAL POLÃTICAS DE USO â”€â”€ */}
...
// MODAL â€” POLÃTICAS DE USO
// ConteÃºdo editÃ¡vel salvo em localStorage
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
const POLICY_DEFAULT = {
  empresa: "Viga â€” SoluÃ§Ãµes em Tecnologia e SeguranÃ§a",
  versao: "1.0.0",
  data: "Abril de 2026",
  clausulas: [
    {
      titulo: "1. Finalidade do Sistema",
      texto: "O Agent Bastos Ã© um sistema de inteligÃªncia corporativa desenvolvido para apoiar atividades de anÃ¡lise, monitoramento e produÃ§Ã£o de conhecimento em seguranÃ§a pÃºblica e corporativa. Seu uso Ã© restrito a agentes devidamente autorizados pela instituiÃ§Ã£o responsÃ¡vel pelo licenciamento.",
    },
    {
      titulo: "2. Responsabilidade pelo Uso",
      texto: "O usuÃ¡rio Ã© integralmente responsÃ¡vel pela utilizaÃ§Ã£o dos dados, relatÃ³rios e anÃ¡lises gerados pelo sistema. Todo acesso Ã© registrado e auditÃ¡vel. O uso indevido das informaÃ§Ãµes, incluindo compartilhamento nÃ£o autorizado ou utilizaÃ§Ã£o para fins pessoais, constitui violaÃ§Ã£o das normas institucionais e pode acarretar sanÃ§Ãµes administrativas, civis e penais.",
    },
    {
      titulo: "3. ProteÃ§Ã£o de Dados â€” LGPD",
      texto: "Este sistema processa dados pessoais de terceiros no estrito cumprimento da Lei Geral de ProteÃ§Ã£o de Dados (Lei nÂº 13.709/2018). Os dados sÃ£o tratados exclusivamente para finalidades legÃ­timas de seguranÃ§a pÃºblica e investigaÃ§Ã£o. O armazenamento, compartilhamento e descarte seguem as diretrizes da LGPD e das normas internas da instituiÃ§Ã£o.",
    },
    {
      titulo: "4. InteligÃªncia Artificial e LimitaÃ§Ãµes",
      texto: "As anÃ¡lises geradas por inteligÃªncia artificial tÃªm carÃ¡ter auxiliar e nÃ£o substituem o julgamento do agente responsÃ¡vel. Toda informaÃ§Ã£o produzida pelo sistema deve ser validada por supervisor humano antes de embasar decisÃµes operacionais. O sistema nÃ£o possui valor probatÃ³rio direto para fins judiciais sem perÃ­cia tÃ©cnica complementar.",
    },
    {
      titulo: "5. Confidencialidade",
      texto: "Todas as informaÃ§Ãµes processadas, relatÃ³rios gerados e anÃ¡lises produzidas sÃ£o classificadas como RESERVADAS e de USO INTERNO. Ã‰ vedada a reproduÃ§Ã£o, cÃ³pia ou divulgaÃ§Ã£o do conteÃºdo do sistema sem autorizaÃ§Ã£o expressa da autoridade competente.",
    },
    {
      titulo: "6. Titularidade e Propriedade Intelectual",
      texto: "O Agent Bastos Ã© produto desenvolvido e licenciado por {empresa}. Todos os direitos de propriedade intelectual, incluindo cÃ³digo-fonte, design, arquitetura e metodologias, sÃ£o de titularidade exclusiva desta empresa. Ã‰ vedada a engenharia reversa, reproduÃ§Ã£o ou distribuiÃ§Ã£o sem autorizaÃ§Ã£o.",
    },
    {
      titulo: "7. VigÃªncia e AtualizaÃ§Ãµes",
      texto: "Estas polÃ­ticas entram em vigor na data de implantaÃ§Ã£o do sistema e podem ser atualizadas a qualquer momento pela administradora do sistema. AlteraÃ§Ãµes serÃ£o comunicadas aos usuÃ¡rios no primeiro acesso apÃ³s a atualizaÃ§Ã£o.",
    },
  ],
}
...
function PoliciesModal({ onClose }) {
  ...
  // Substitui {empresa} no texto pelo nome atual
          ...
          <div>
            <div style={{display:"flex", alignItems:"center", gap:8, marginBottom:4}}>
              ...
              <span style={{fontSize:9, fontWeight:700, color:"#64748B", letterSpacing:"0.15em", textTransform:"uppercase"}}>
                Agent Bastos Â· Documento Institucional
              </span>
            </div>
            ...
            <div style={{display:"flex", gap:16, marginTop:8}}>
              {[["VersÃ£o", data.versao], ["VigÃªncia", data.data], ["Status", "ATIVO"]].map(([k,v])=>(
                <div key={k}>
        ...
        <div style={{overflowY:"auto", padding:"20px 28px", display:"flex", flexDirection:"column", gap:16}}>
          ...
          <div style={{
            ...
            <span style={{fontSize:10, color:"#94A3B8", fontFamily:MONO_P}}>
              Agent Bastos Â· Intelligence System
            </span>
